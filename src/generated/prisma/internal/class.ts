...
/**
  ...
  /**
   * `prisma.playLog`: Exposes CRUD operations for the **PlayLog** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more PlayLogs
    * const playLogs = await prisma.playLog.findMany()
    * ```
    */
  get playLog(): Prisma.PlayLogDelegate<ExtArgs, { omit: OmitOpts }>;
